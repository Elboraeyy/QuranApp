...
val QuranTypography = Typography(
    ...
    titleSmall = TextStyle(
        ...
        fontWeight = FontWeight.Medium,
        fontSize = 14.sp,
        lineHeight = 24.sp, // Increased line height
    ...
    bodyLarge = TextStyle(
        ...
        fontSize = 16.sp,
        lineHeight = 28.sp, // Elegant, breathable line height
...
// Extension for Quranic Text
val TextStyle.quranic: TextStyle
    get() = copy(fontFamily = ScheherazadeNew)